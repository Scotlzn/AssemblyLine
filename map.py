...
class Map:
    ...
    def generate_images(self):
        ...
        tiles = [
            ...
            pygame.image.load('./Assets/Tiles/furnace.png').convert(),
            pygame.image.load('./Assets/Tiles/compressor.png').convert(),
            pygame.image.load('./Assets/Tiles/hydraulicpress.png').convert(),
